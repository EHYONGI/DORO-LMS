            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-14">
                    ...
                    <div className="hidden md:flex space-x-12">
                        {/* 수강신청 → /student/course */}
                        <Link href="/student/course" className="hover:text-gray-200 text-sm font-medium">
                            수강신청
                        </Link>
                        ...
                        {/* 상담페이지 → /student/consultation */}
                        <Link href="/student/consultation" className="hover:text-gray-200 text-sm font-medium">
                            상담페이지
                        </Link>
