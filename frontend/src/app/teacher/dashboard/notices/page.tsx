...
export default function TeacherAllNoticesPage() {
    ...
    const handleNoticeClick = (notice: Notice) => {
        if (notice.type === 'lecture' && notice.lecture) {
            router.push(`/teacher/dashboard/courses/${notice.lecture}/notices/${notice.id}`);
        } else {
            router.push(`/teacher/dashboard/notices/${notice.id}`);
        }
    };
