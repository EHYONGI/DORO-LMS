...
class LectureApplication(models.Model):
    lecture = models.ForeignKey(Lecture, on_delete=models.CASCADE, related_name="applications")
    instructor = models.ForeignKey(User, on_delete=models.CASCADE, related_name="lecture_applications")
    applied = models.TextField(blank=True, null=True)
    received = models.TextField(blank=True, null=True)
    manager = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="managed_applications")
    def __str__(self):
